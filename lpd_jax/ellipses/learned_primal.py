...
def main() -> None:
  """
  Serves as the main execution loop for running Learned Primal on generated data.
  """
  ...
  print("Building Model: Learned Primal.")
  ...
  model = LearnedPrimal(geometry=geom, n_iter=10, op_norm=opnorm)
